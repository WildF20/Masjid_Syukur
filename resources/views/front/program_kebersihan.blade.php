...
@section('title', 'Program Pendidikan & Keputrian')
...
<div class="hero-area height-600 bg-img background-overlay" style="background-image: url(img/blog-img/bg5.jpg);">
    ...
    <div class="main-content-wrapper section-padding-100 clear-fix">
        <div class="container">
            <div class="">
                <!-- ============= Post Content Area ============= -->
                <h2>Program Unggulan Kebersihan dan Keamanan Masjid</h2>
                <p>Berikut adalah program unggulan bidang Kebersihan dan Keamanan yang terdapat pada masjid syukur ampel</p>
