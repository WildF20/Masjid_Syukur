...
<div class="hero-area height-600 bg-img background-overlay" style="background-image: url(img/blog-img/bg5.jpg);">
    ...
    <div class="main-content-wrapper section-padding-100 clear-fix">
        <div class="container">
            <div class="">
                <!-- ============= Post Content Area ============= -->
                <h2>Program Unggulan Publikasi dan Dokumentasi</h2>
                <p>Berikut adalah program unggulan bidang Publikasi dan Dokumentasi yang terdapat pada masjid syukur ampel</p>
